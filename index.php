...
<!--Reviews-->
<div style="background:url(<?php echo get_bloginfo('template_url') ?>/assets/images/fondo-trama.png); background-position: center; background-size: cover;">
  <div class="mx-auto container max-w-[780px] pt-20 pb-12">
    <h2 class="text-5xl text-[#60726e] font-bold tracking-[1px] text-center mb-16 font-montserrat-alternate">¿Qué dicen de nosotros?</h2>
    <div class="reviews-slider overflow-hidden">
      <ul class="swiper-wrapper">
        <li class="swiper-slide">
          <?php get_template_part('template-parts/comillas', null, ['class' => 'mb-16 mx-auto block']) ?>
          <p class="text-center mb-8 text-[#4a5052] text-xl font-light">
          ...
          <h4 class="text-[#60726e] text-center font-bold text-xl">CLAUDIA CAMBLOR</h4>
          <p class="text-center text-[#4a5052] text-xl font-light">Instalación cortinas Roller Duos</p>
        </li>
        <li class="swiper-slide">
          <?php get_template_part('template-parts/comillas', null, ['class' => 'mb-16 mx-auto block']) ?>
          <p class="text-center mb-8 text-[#4a5052] text-xl font-light">
          ...
          <h4 class="text-[#60726e] text-center font-bold text-xl">JORGE ARRAU</h4>
          <p class="text-center text-[#4a5052] text-xl font-light">Productor de Eventos</p>
        </li>
      </ul>
